...
var filterProtectorListStore = Ext.create('Ext.data.Store', {
    fields: ['gpId', 'psName'],
    data: [ 
            {"gpId": "11", "psName": "葛岭变总保"},
            {"gpId": "12", "psName": "葛岭变二级保1"},
            {"gpId": "13", "psName": "葛岭变二级保2"},
            {"gpId": "14", "psName": "葛岭变二级保3"},
            {"gpId": "15", "psName": "葛岭变二级保4"},
            {"gpId": "16", "psName": "葛岭变二级保5"},
            {"gpId": "17", "psName": "东兴变总保"},
            {"gpId": "18", "psName": "东兴变二级保1"},
            {"gpId": "19", "psName": "东兴变二级保2"},
            {"gpId": "20", "psName": "东兴变二级保3"},
            {"gpId": "21", "psName": "东兴变二级保4"},
            {"gpId": "22", "psName": "东兴变二级保5"},
            {"gpId": "23", "psName": "台区三总保"},
            {"gpId": "24", "psName": "台区三二级保1"},
            {"gpId": "25", "psName": "台区三二级保2"},
            {"gpId": "26", "psName": "台区三二级保3"},
            {"gpId": "27", "psName": "台区三二级保4"},
            {"gpId": "28", "psName": "台区三二级保5"}
    ]
});
